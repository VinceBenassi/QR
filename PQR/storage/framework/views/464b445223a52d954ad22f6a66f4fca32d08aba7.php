    ...
    <body>
        <div id="principal" class="content">
            ...
            <div class="separacion">
                ...
                <small> Confirme sus datos personales: <?php echo e($n_rut); ?></small>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="<?php echo e(route('registro')); ?>" method="POST" onSubmit="return confirm('Está seguro de los datos ingresados?');">
...
</html><?php /**PATH C:\Users\Admin\Documents\traza.uct.cl\resources\views/registro.blade.php ENDPATH**/ ?>