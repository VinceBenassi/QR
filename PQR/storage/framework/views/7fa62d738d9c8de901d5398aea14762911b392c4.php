                            ...
                            <div class="card-body">
                                ...
                                <?php echo csrf_field(); ?>                              
                                    ...
                                    <div class="container col-md-4 mb-3">
                                        <label for="num_rut" class="dato_label"><?php echo e($n_rut); ?></label><br>
                                        <label for="num_rut" class="dato_label"><?php echo e($n_com); ?></label>
                                    </div>
                                    ...
                                    <div class="container col-md-4 mb-3 oficina">
                                        ...
                                        <input value="<?php echo e($carg); ?>" type="text" class="form-control hide" name="oficina_cargo" id="oficina_cargo" placeholder="Oficina" disabled>
                                    </div>
...
</html><?php /**PATH C:\Users\Admin\Documents\traza.uct.cl\resources\views/confirma.blade.php ENDPATH**/ ?>