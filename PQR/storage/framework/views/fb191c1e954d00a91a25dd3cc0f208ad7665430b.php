                            ...
                            <div class="card-body">
                                <form action="qr">
                                    ...
                                    <div class="container col-md-4 mb-3">
                                        ...
                                        <label for="num_rut" class="datos form-label dato_label">Juan Eduardo Perez Martinez</label>
                                    </div><br>

                                    <div class="container col-md-4 mb-3">
                                        <label for="telef" class="datos form-label">Número de teléfono (*)</label>
                                        <input type="tel" class="form-control" id="tel1" name="telef1" placeholder="Ingrese numero telefonico"  minlength="9" maxlength="12"  
                                        required pattern="[0-9]+" oninput="checkNum()"/>
                                    </div>

                                    <div class="container col-md-4 mb-3">
                                        <input type="tel" class="form-control" id="tel2" name="telef2" placeholder="Re ingrese su numero telefonico"  minlength="9" maxlength="12" 
                                        required pattern="[0-9]+" oninput="checkNum()"/>
                                    </div>
...
</html><?php /**PATH C:\Users\Admin\Documents\QR\PQR\resources\views/confirm.blade.php ENDPATH**/ ?>